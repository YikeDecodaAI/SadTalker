...
def on_ui_tabs():
    ...
    audio_to_video = sadtalker_demo(checkpoint_path=checkpoint_path, config_path=repo_dir + 'src/config',
...
def on_ui_settings():
    ...
    opts.add_option("sadtalker_result_dir",
                    OptionInfo(str(talker_path / "SadTalker/"), "Path to save results of sadtalker", section=section))
